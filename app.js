...
maxPolitenessPoints: 10,
modelAnswers: [
"Guten Tag, ich hätte gern ein Tagesticket {{detail}} für {{peopleText}}.",
...
inputType: "choice",
npcText: "",
prompt: "Du möchtest ein Ticket {{detail}} für {{peopleText}}.",
hint: "Muster: Ich hätte gern ein Ticket ...",
options: [
{
text: "Ich hätte gern ein Ticket {{detail}} für {{peopleText}}, bitte.",
correct: true,
feedback: "Sehr gut, klarer Wunsch und höflich.",
politeness: 3
},
{
text: "Ticket {{detail}}, schnell.",
correct: false,
...
replacements.detail = pickRandom(config.details);
  ...
  // Add aliases for plural keys to handle template inconsistencies
  replacements.dates = replacements.date;
  replacements.times = replacements.time;
  replacements.details = replacements.detail;
